...
Required repository gate: JPEG, RGB, exactly 1,600 × 2,560 px, under 50 MB, correct title/author/series/Book 6 text, thumbnail-legible, crop-safe, series-consistent, and explicitly approved.
...
- a permanent `books/book-06/release/` snapshot;
...
- Root Book 6 status: `in_progress`.

Provided the metadata/tooling checks remain green, the missing or unapproved cover is the only package blocker. Local validation: 12/13 checks passed, `validate-readiness.py` status `blocked`.
